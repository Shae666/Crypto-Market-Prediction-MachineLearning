...
<head>
  ...
  <title>User Home | About :: Benil </title>
  ...
  <section class="w3l-inner-page-breadcrumb">
    <div class="breadcrumb-bg py-5">
      <div class="container pt-lg-5 pt-md-3 p-lg-4 pb-md-3 my-lg-3">
        <h2 class="title pt-5">Hello User.! </h2>
        <ul class="breadcrumbs-custom-path mt-3 text-center">
          <li><a href="index.html">Home</a></li>
          <li class="active"><span class="fa fa-arrow-right mx-2" aria-hidden="true"></span> User </li>
  ...
  <section class="w3l-about py-5" id="about">
    <div class="container py-lg-4 py-md-3">
      <div class="about-block text-center">
        <p><a href="#url" class="img-height"> <img src="assets/images/organizer1.jpeg" alt="" class="radius-image img-fluid mt-md-5 mt-4"></a></p>
        <p>&nbsp;</p>
        <p align="center"><span class="style1">	“An event is not over until everyone is tired of talking about it.”</span> </p>
      </div>
    </div>
    </div>
</section>
        ...
        <div class="container py-lg-5">
            <div class="title-content text-center">
              <div class="header-title">
                ...
                <h3 class="title-w3l">Our Organizers</h3>
              </div>
            ...
            <div class="row mt-md-5 mt-4">
                <div class="col-lg-3 col-6 team-wrap">
                    <div class="team-member">
                        <div class="team-img">
                            <img src="assets/images/s1.jpg" alt="" class="radius-image img-fluid">
                        </div>
                ...
                <div class="col-lg-3 col-6 team-wrap">
                    <div class="team-member">
                        <div class="team-img">
                            <img src="assets/images/s2.jpg" alt="" class="radius-image img-fluid">
                        </div>
                ...
                <div class="col-lg-3 col-6 team-wrap mt-lg-0 mt-5">
                    <div class="team-member last ">
                        <div class="team-img">
                            <img src="assets/images/s3.jpg" alt="" class="radius-image img-fluid">
                        </div>
                ...
                <div class="col-lg-3 col-6 team-wrap mt-lg-0 mt-5">
                    <div class="team-member last ">
                        <div class="team-img">
                            <img src="assets/images/s4.jpg" alt="" class="radius-image img-fluid">
                        </div>
                ...
                <div class="col-lg-3 col-6 team-wrap mt-5 pt-lg-2">
                    <div class="team-member last ">
                        <div class="team-img">
                            <img src="assets/images/s5.jpg" alt="" class="radius-image img-fluid">
                        </div>
                        <a href="#url" class="team-title">Sara grant</a>
                        <p> Organizer</p>
                    </div>
                ...
                <div class="col-lg-3 col-6 team-wrap mt-5 pt-lg-2">
                    <div class="team-member last ">
                        <div class="team-img">
                            <img src="assets/images/s6.jpg" alt="" class="radius-image img-fluid">
                        </div>
                        <a href="#url" class="team-title">Sara grant</a>
                        <p> Organizer</p>
                    </div>
    ...
    <div class="footer7 py-5">
      <div class="container py-lg-3">
        ...
        <div class="copy-right-hny text-center">
          <p>© 2021 Festivity. All rights reserved.Design by <a href="https://w3layouts.com/" target="_blank">
              W3Layouts</a>
          </p>
        </div>
      </div>
