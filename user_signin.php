...
{
$max_qry = mysql_query("select max(id) from user_signin");
	$max_row = mysql_fetch_array($max_qry);
	$id=$max_row['max(id)']+1;
$qry = mysql_query("insert into user_signin values('$id','$username','$password','$email','$number','$address')");
...
<head>
  ...
  <title>User Signin | About :: Benil </title>
...
-->
		...
		.image{
			background-image: url('assets/images/user03.jpg')
		}
</style></head>
  ...
  <section class="w3l-inner-page-breadcrumb">
    <div class="breadcrumb-bg image py-5">
      <div class="container pt-lg-5 pt-md-3 p-lg-4 pb-md-3 my-lg-3">
        <h2 class="title pt-5">CREATE AN ACCOUNT</h2>
        <p class="title pt-5">&nbsp;</p>
        <form name="form1" method="post" action="">
          <table width="422" border="0" align="center">
            <tr>
              <td width="155"><span class="style1">User Name </span></td>
              <td width="278"><label>
                <div align="center">
            ...
            <tr>
              ...
              <td><label>
                <div align="center">
                  <input name="email" type="text" id="email" required email>
                </div>
              </label></td>
            </tr>
            <tr>
