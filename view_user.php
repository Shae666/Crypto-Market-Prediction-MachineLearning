...
<head>
  ...
  <title>View User | About :: Benil </title>
  ...
  <section class="w3l-inner-page-breadcrumb">
    <div class="breadcrumb-bg py-5">
      <div class="container pt-lg-5 pt-md-3 p-lg-4 pb-md-3 my-lg-3">
        <h2 class="style10 pt-5 title">USERS</h2>
        <p class="title pt-5">&nbsp;</p>
        <form name="form1" method="post" action="">
          <table width="50%" height="78"  align="center">
            <tr>
              <td width="6%"><span class="style12">Id</span></td>
              <td width="19%"><span class="style12">User name</span></td>
              <td width="28%"><span class="style12">Email Address </span></td>
              <td width="30%"><span class="style12">Phone Number </span></td>
              <td width="17%"><span class="style12">Address</span></td>
            </tr>
            <?php
			$qrys1 = mysql_query("select * from user_signin");
	 ...
	 ?>
            <tr>
              ...
              <td><span class="style13"><?php echo $row['username'];?></span></td>
              <td><span class="style13"><?php echo $row['email'];?></span></td>
              <td><span class="style13"><?php echo $row['number'];?></span></td>
              <td><span class="style13"><?php echo $row['address'];?></span></td>
            </tr>
            <?php
	 }
	 ?>
