...
<head>
  ...
  <title>Bookings | About :: Benil </title>
  ...
  <section class="w3l-inner-page-breadcrumb">
    <div class="breadcrumb-bg py-5">
      <div class="container pt-lg-5 pt-md-3 p-lg-4 pb-md-3 my-lg-3">
        <h2 class="title pt-5 style9">CLIENT DETAILS</h2>
        <p class="title pt-5">&nbsp;</p>
        <form name="form1" method="post" action="">
          <table width="50%" height="78"  align="center">
            <tr>
              <td width="5%"><span class="style12">Id</span></td>
			  <td width="21%"><span class="style12">User Name </span></td>
              <td width="21%"><span class="style12">Stock Name </span></td>
              <td width="26%"><span class="style12">Adjustment Value </span></td>
	 ...
	 ?>
            <tr>
              <td><span class="style9"><?php echo $row['id'];?></span></td>
			   <td><span class="style9"><?php echo $row['uname'];?></span></td>
              <td><span class="style9"><?php echo $row['ename'];?></span></td>
              <td><span class="style9"><?php echo $row['hallname'];?></span></td>
              <td><span class="style9"><?php echo $row['price'];?></span></td>
            </tr>
            <?php
	 }
	 ?>
