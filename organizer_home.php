...
<head>
  ...
  <title>Client Home | About :: Benil</title>
      ...
      <img src="image-path" alt="Your logo" title="Your logo" style="height:35px;" />
        ...
        <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
          <ul class="navbar-nav mx-lg-auto">
            ...
            <li class="nav-item">
              <a class="nav-link" href="organizer_viewbookings.php">View Details</a>            </li>
            <li class="nav-item">
              <a class="nav-link" href="add_events.php">Add Market details</a>            </li>
  ...
  <section class="w3l-inner-page-breadcrumb">
    <div class="breadcrumb-bg py-5">
      <div class="container pt-lg-5 pt-md-3 p-lg-4 pb-md-3 my-lg-3">
        <h2 class="title pt-5">Welcome Client.! </h2>
  ...
  <section class="w3l-about py-5" id="about">
    <div class="container py-lg-4 py-md-3">
      <div class="about-block text-center">
        <p><a href="#url" class="img-height"> <img src="assets/images/x1.jpg" alt="" class="radius-image img-fluid mt-md-5 mt-4"> </a> </p>
        <p>&nbsp;</p>
        <div align="center" class="style2">“To achieve great things, two things are needed: a plan and not quite enough time.”        
		</div>
        <p>&nbsp;</p>
      </div>
    </div>
        ...
        <div class="container py-lg-5">
            <div class="title-content text-center">
              <div class="header-title">
                ...
                <h3 class="title-w3l">Our Clients</h3>
              </div>
            ...
            <div class="row mt-md-5 mt-4">
                <div class="col-lg-3 col-6 team-wrap">
                    <div class="team-member">
                        <div class="team-img">
                            <img src="assets/images/z1.jpg" alt="" class="radius-image img-fluid">
                        </div>
                ...
                <div class="col-lg-3 col-6 team-wrap">
                    <div class="team-member">
                        <div class="team-img">
                            <img src="assets/images/z2.jpg" alt="" class="radius-image img-fluid">
                        </div>
                        <a href="#url" class="team-title">Elon Musk</a>
                        <p> Organizer</p>
                    </div>
                </div>
                <!-- end team member -->
                ...
                <div class="col-lg-3 col-6 team-wrap mt-lg-0 mt-5">
                    <div class="team-member last ">
                        <div class="team-img">
                            <img src="assets/images/z3.jpg" alt="" class="radius-image img-fluid">
                        </div>
                        <a href="#url" class="team-title">Bill Gates</a>
                        <p> Organizer</p>
                    </div>
                </div>
                <!-- end team member -->
                ...
                <div class="col-lg-3 col-6 team-wrap mt-lg-0 mt-5">
                    <div class="team-member last ">
                        <div class="team-img">
                            <img src="assets/images/z4.jpg" alt="" class="radius-image img-fluid">
                        </div>
                ...
                <div class="col-lg-3 col-6 team-wrap mt-5 pt-lg-2">
                    <div class="team-member last ">
                        <div class="team-img">
                            <img src="assets/images/z5.jpg" alt="" class="radius-image img-fluid">
                        </div>
                        <a href="#url" class="team-title">Sara grant</a>
                        <p> Organizer</p>
                    </div>
                ...
                <div class="col-lg-3 col-6 team-wrap mt-5 pt-lg-2">
                    <div class="team-member last ">
                        <div class="team-img">
                            <img src="assets/images/z6.jpg" alt="" class="radius-image img-fluid">
                        </div>
                        <a href="#url" class="team-title">Steve jobs</a>
                        <p> Organizer</p>
                    </div>
                </div>
                <!-- end team member -->
                ...
                <div class="col-lg-3 col-6 team-wrap mt-5 pt-lg-2">
                    <div class="team-member last ">
                        ...
                        <a href="#url" class="team-title">Mathew</a>
                        <p> Organizer</p>
                    </div>
                </div>
                <!-- end team member -->

                <div class="col-lg-3 col-6 team-apply align-self">
                    <h4 class="join-title">Interested to join
                        our team ?</h4>
                    <a href="#btn" class="btn link-style p-0">Join Now <span class="fa fa-long-arrow-right"></span></a>
                </div>
    ...
    <div class="footer7 py-5">
      <div class="container py-lg-3">
        <div class="footer-destinations mb-3 text-center">
          <h5>Don't look for the needle in the haystack. Just buy the haystack.</h5>
        </div>
        <div class="d-grid grid-col-3 footer-top7">
          ...
          <div class="footer-list7 mt-4">
            ...
            <ul class="phone-numbers">
              <li><a href="tel:+123456790"> +123456790</a></li>
              <li><a href="tel:+123456791"> +123456791</a></li>
            </ul>
        ...
        <div class="copy-right-hny text-center">
          <p>© 2021 Festivity. All rights reserved.Design by <a href="" target="_blank">
              Francis</a>
          </p>
        </div>
      </div>
